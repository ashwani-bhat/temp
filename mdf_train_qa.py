...
if __name__ == '__main__':
    ...
    parser.add_argument('--trainfold', type=int, default=1, metavar='F', help='which fold to train')
    parser.add_argument('--testfold', type=int, default=1, metavar='F', help='which fold to test')
    ...
    if context == False:
        save_dir    = 'outputs/' + model_id[model] + '-dailydialog-qa-without-context-fold' + trainfold + '_' + testfold + '/'
        result_file = 'outputs/' + model_id[model] + '-dailydialog-qa-without-context-fold' + trainfold + '_' + testfold + '/results.txt'
        dump_file   = 'outputs/' + model_id[model] + '-dailydialog-qa-without-context-fold' + trainfold + '_' + testfold  + '/test_predictions.pkl'
        x_train = json.load(open('data/qa/fold' + trainfold + '/dailydialog_qa_train_without_context.json'))
        x_valid = json.load(open('data/qa/fold' + trainfold + '/dailydialog_qa_valid_without_context.json'))
        x_test  = json.load(open('data/qa/fold' + testfold + '/dailydialog_qa_test_without_context.json'))
    else:
        save_dir    = 'outputs/' + model_id[model] + '-dailydialog-qa-with-context-fold' + trainfold + '_' + testfold + '/'
        result_file = 'outputs/' + model_id[model] + '-dailydialog-qa-with-context-fold' + trainfold + '_' + testfold + '/results.txt'
        dump_file   = 'outputs/' + model_id[model] + '-dailydialog-qa-with-context-fold' + trainfold + '_' + testfold + '/test_predictions.pkl'
        x_train = json.load(open('data/qa/fold' + trainfold + '/dailydialog_qa_train_with_context.json'))
        x_valid = json.load(open('data/qa/fold' + trainfold + '/dailydialog_qa_valid_with_context.json'))
        x_test  = json.load(open('data/qa/fold' + testfold + '/dailydialog_qa_test_with_context.json'))
